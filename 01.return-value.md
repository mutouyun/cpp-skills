...
<div align=center><img src="https://yuml.me/diagram/plain;dir:LR/class/[rc_string%7C-str_:char*%7C+~rc_string()],[Str%7C+~Str();+Str&%20operator+=(const%20char*)%7Bbg:tomato%7D],[Str]%3C%3E*-1%3E[rc_string],[Str]-[note:Multiple%20Str%20objects%20use%20a%20same%20rc-string%7Bbg:cornsilk%7D],[rc_base%7C+inc();+dec()]%5E-[rc_string]"/></div>
